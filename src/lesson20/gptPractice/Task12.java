 ...
 */
        ...
        while (true) {
            double tripCost = getTripInfo(scanner);
            totalForDay += tripCost;

            System.out.println("Another trip? (y/n)");
        ...
        System.out.println("Total cost for all trips: " + totalForDay + " €");
    }

    public static double getTripInfo(Scanner scanner) {
